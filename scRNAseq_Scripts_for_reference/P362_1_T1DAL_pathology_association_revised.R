...
T1DAL_QR_cpeptide <- read.csv(file.path(dataDir,"T1DAL_cpeptide_rates_QR_for_EWitkop.2023-09-29.csv"))
...
## FIGURE 6A:
ggsave(cpeptide_fixed_facet, file = "./FIGURES/cpeptide_fixed_facet.pdf", width = 8, height = 5)
...
## FIGURE 6B:
ggsave(cpeptide_fixed_quartile_Tex_plot, file = "./FIGURES/cpeptide_fixed_quartile_Tex_plot.pdf", width = 8, height = 5)
