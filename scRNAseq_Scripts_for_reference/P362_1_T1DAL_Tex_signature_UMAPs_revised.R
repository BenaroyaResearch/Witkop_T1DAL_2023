...
plotDir <- "/Users/ewitkop/Library/CloudStorage/Box-Box/EW_Bioinformatics_Postdoc_Research/T1DAL_10X_Project/ANALYSIS_FILES/FIGURES"
...
dataDir <- "/Users/ewitkop/Library/CloudStorage/Box-Box/EW_Bioinformatics_Postdoc_Research/T1DAL_10X_Project/ANALYSIS_FILES/RAW_DATA/"
...
#### FIGURE S16D: PLOT GENE LISTS FROM OTHER PUBLISHED DATASETS ONTO UMAPs ####
...
Li_KIR_non_ex_CD57 <- read_excel(file.path(dataDir, "P452-1/Published_KIR_gene_sets/Li_Davis_2022_KIR/science.abi9591_tables_s1_to_s7/science.abi9591_table_s3.xlsx"),
                                 sheet=1) %>% 
...
Giles_CD57_Tex <- read_excel(file.path(dataDir, "P452-1/Compiled_gene_lists/Giles_Wherry_2022_Supplementary_Table_1_DEGs_by_cluster.xlsx"),
                             # get sheet 3 only 
                             sheet = 3) %>%
...
Daniel_CD57_Tex <- read_excel(file.path(dataDir, "P452-1/Compiled_gene_lists/Daniel_science_41590_2022_1337_MOESM2_ESM.xlsx"), 
...
EOMES_mod <- read_excel(file.path(dataDir, "P452-1/Compiled_gene_lists/Long_science_eaai7793_tables_s1_to_s4/aai7793_Table S2.xlsx"))
...
Zheng_S3_CD8 <- read_excel(file.path(dataDir, "P452-1/Compiled_gene_lists/Zheng_science.abe6474_tables_s1_to_s4/science.abe6474_table_s3.xlsx"), sheet = 2, skip = 1)
...
#### FIGURE S16C: Assess overlap between DGEA genes in CD57 vs all other clusters and loaded gene sets ####
