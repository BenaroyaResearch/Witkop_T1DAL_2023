...
### This script re-runs and edits the original K.Diggins scripts
## This script produces the main UMAP plots from her analysis
...
### Original code from Kirsten
#load("C:/Users/kdiggins/Box/P362-1 T1DAL 10X/P362-1 T1DAL cds object - postQC no MAIT cells - more clusters.Rdata")
#load("C:/Users/kdiggins/Box/P362-1 T1DAL 10X/P362-1 T1DAL TCR data per cell.Rdata")
...
# Load T1DAL TCR data per cell 
#load("./ANALYSIS_FILES/T1DAL_Results/P362-1 T1DAL TCR data per cell.Rdata")
...
# PLOT FIGURE 3B - not annotations were added afterward in Inkscape
ggsave(cds_data_cluster_no_MAIT_no_9, file = "./FIGURES/cds_data_cluster_no_MAIT_no_9.tiff", device = "tiff", width= 8, height = 6)
...
#### FIGURE S16A, FIGURE S16B: Plot heatmaps with published gene lists ####
...
Giles_Wherry_Figure_3b_gene_list <- readxl::read_xlsx("/Users/ewitkop/Library/CloudStorage/Box-Box/EW_Bioinformatics_Postdoc_Research/T1DAL_10X_Project/ANALYSIS_FILES/RAW_DATA/P452-1/Published_KIR_gene_sets/Giles_Wherry_Figure_3b_gene_list.xlsx")
Figure_S3A_heatmap_gene_set <- readxl::read_xlsx("/Users/ewitkop/Library/CloudStorage/Box-Box/EW_Bioinformatics_Postdoc_Research/T1DAL_10X_Project/ANALYSIS_FILES/RAW_DATA/P452-1/Published_KIR_gene_sets/Li_Davis_2022_KIR/Figure_S3A_heatmap_gene_set.xlsx")
...
## PLOT FIGURE S16B
pdf(file = "./FIGURES/Daniel_Wherry_2022_Figure2b_Texterm_TexKLR_gene_list_zscore_heatmap.pdf", width = 5, height = 9)
Daniel_Wherry_2022_Figure2b_Texterm_TexKLR_gene_list_zscore_heatmap
dev.off()
...
### Plot FIGURE S16A
pdf(file = "./FIGURES/Figure_S3A_heatmap_gene_set_zscore_heatmap.pdf", width = 5, height = 9)
Figure_S3A_heatmap_gene_set_zscore_heatmap
dev.off()
